...
namespace CE.Domain
{
    public struct CoreSchemaTableName
    {
    ...
    public struct CoreSchemaFieldName
    {
    ...
    public struct CoreFieldNames
    {
        public const string InfoName = "InfoName";
        public const string Value = "Value";
    }
    public struct CoreFieldLabelKeys
    {
    ...
    public struct StandardInfoNames
    {
        ...
        public const string BUDGET_DAYS_OFFSET = "BUDGET_DAYS_OFFSET";
    }
